...
class EmrSubmitAndMonitorStepOperator(BaseOperator):
    ...
    def execute(self, context: Dict[str, Any]) -> List[str]:
        ...
        response = self.add_step(job_flow_id, steps)
    ...
    def describe_step(self, clusterid: str, stepid: str, tries=1) -> dict:
        """
        ...
        try:
            ...
            if exception_obj.response["Error"]["Code"] == "ThrottlingException":
                if tries <= 10:
                    ...
                    time.sleep(30)
                    return self.describe_step(clusterid, stepid, tries + 1)
                else:
